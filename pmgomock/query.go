...
// Source: /Users/luoji/gopath/src/github.com/gunsluo/pmgo/query.go
...
func (m *MockQueryManager) Apply(change mgo.Change, result interface{}) (*mgo.ChangeInfo, error) {
...
func (m *MockQueryManager) Batch(n int) pmgo.QueryManager {
...
func (m *MockQueryManager) Comment(comment string) pmgo.QueryManager {
...
func (m *MockQueryManager) Hint(indexKey ...string) pmgo.QueryManager {
	varargs := []interface{}{}
...
func (m *MockQueryManager) Iter() *mgo.Iter {
...
func (m *MockQueryManager) Limit(n int) pmgo.QueryManager {
...
func (m *MockQueryManager) LogReplay() pmgo.QueryManager {
...
func (m *MockQueryManager) MapReduce(job *mgo.MapReduce, result interface{}) (*mgo.MapReduceInfo, error) {
...
func (m *MockQueryManager) Prefetch(p float64) pmgo.QueryManager {
...
func (m *MockQueryManager) Select(selector interface{}) pmgo.QueryManager {
...
func (m *MockQueryManager) SetMaxScan(n int) pmgo.QueryManager {
...
func (m *MockQueryManager) SetMaxTime(d time.Duration) pmgo.QueryManager {
...
func (m *MockQueryManager) Skip(n int) pmgo.QueryManager {
...
func (m *MockQueryManager) Snapshot() pmgo.QueryManager {
...
func (m *MockQueryManager) Sort(fields ...string) pmgo.QueryManager {
	varargs := []interface{}{}
...
func (m *MockQueryManager) Tail(timeout time.Duration) pmgo.IterManager {
	ret := m.ctrl.Call(m, "Tail", timeout)
	ret0, _ := ret[0].(pmgo.IterManager)
	return ret0
}
