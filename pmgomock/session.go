...
// Source: /Users/luoji/gopath/src/github.com/gunsluo/pmgo/session.go
...
func (m *MockSessionManager) BuildInfo() (mgo.BuildInfo, error) {
...
func (m *MockSessionManager) Clone() pmgo.SessionManager {
...
func (m *MockSessionManager) Copy() pmgo.SessionManager {
...
func (m *MockSessionManager) DB(name string) pmgo.DatabaseManager {
...
func (m *MockSessionManager) EnsureSafe(safe *mgo.Safe) {
...
func (m *MockSessionManager) FindRef(ref *mgo.DBRef) pmgo.QueryManager {
...
func (m *MockSessionManager) Login(cred *mgo.Credential) error {
...
func (m *MockSessionManager) Mode() mgo.Mode {
...
func (m *MockSessionManager) New() pmgo.SessionManager {
...
func (m *MockSessionManager) Safe() *mgo.Safe {
...
func (m *MockSessionManager) SetMode(consistency mgo.Mode, refresh bool) {
...
func (m *MockSessionManager) SetSafe(safe *mgo.Safe) {
